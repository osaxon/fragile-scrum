...
export type LatestScoresRecord = {
  created?: IsoDateString
  id: string
  latestScore?: number
...
export type LatestScoresResponse<Texpand = unknown> =
  Required<LatestScoresRecord> & BaseSystemFields<Texpand>
...
export type StoriesResponse<Texpand = unknown> = Required<StoriesRecord> &
  BaseSystemFields<Texpand>
export type StoryMetricsResponse<
  TavgScore = unknown,
  Texpand = unknown
> = Required<StoryMetricsRecord<TavgScore>> & BaseSystemFields<Texpand>
